...
class Settings:
    ...
    LLM_PROVIDER: str = getenv("LLM_PROVIDER", "openai_compatible")
    ANTHROPIC_API_KEY: str | None = getenv("ANTHROPIC_API_KEY")
    OPENAI_COMPATIBLE_API_KEY: str = getenv("OPENAI_COMPATIBLE_API_KEY", "ollama")
    OPENAI_COMPATIBLE_BASE_URL: str = getenv("OPENAI_COMPATIBLE_BASE_URL", "https://api.openai.com/v1")
    OPENAI_COMPATIBLE_MODEL: str = getenv("OPENAI_COMPATIBLE_MODEL", "gpt-5-nano")
    ...
    DEFAULT_MODEL: str = getenv("DEFAULT_MODEL", "gpt-5-nano")
    REQUIRE_ANTHROPIC_ON_STARTUP: bool = getenv("REQUIRE_ANTHROPIC_ON_STARTUP", "false").lower() == "true"
